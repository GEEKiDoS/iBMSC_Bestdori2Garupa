...
Partial Public Class MainWindow
    ...
    Private Function GetBMSChannelBy(note As Note) As String
        ...
        If iCol >= niA1 And iCol <= niA8 Then
            If xLong Then
                Return Hex(bmsBaseChannel + System.Convert.ToInt32("50", 16) - 10)
            End If
            If xHidden Then
                Return Hex(bmsBaseChannel + System.Convert.ToInt32("30", 16) - 10)
            End If
            If xLandmine Then
                Return Hex(bmsBaseChannel + System.Convert.ToInt32("D0", 16) - 10)
            End If
        End If
        ...
        If iCol >= niD1 And iCol <= niD8 Then
            If xLong Then
                Return Hex(bmsBaseChannel + System.Convert.ToInt32("60", 16) - 20)
            End If
            If xHidden Then
                Return Hex(bmsBaseChannel + System.Convert.ToInt32("40", 16) - 20)
            End If
            If xLandmine Then
                Return Hex(bmsBaseChannel + System.Convert.ToInt32("E0", 16) - 20)
            End If
        End If
